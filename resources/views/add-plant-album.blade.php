...
<div class="flex ml-[5rem] mr-[5rem] mt-[6rem] flex-col">
    ...
    <div class="mx-auto border-[3px] p-12  mb-16">
        <form class="flex flex-col">
            ...
            <input type="text" name="albumName" id="albumName" class="mt-1 p-2 border-b-2 border-gray-300 outline-none w-[36rem] text-[18px] mb-[4rem]" required>
            ...
            <div class="flex flex-row mb-16 gap-32">
                ...
                <div class="flex flex-col">
                    ...
                    <label class="bg-lightGreen p-10 w-[32rem] mb-[2rem] font-semibold text-[24px] rounded-3xl text-center cursor-pointer focus-within:bg-normalGreen focus-within:text-white transition-all duration-100">
                        <input type="radio" name="status" value="ongoing" class="opacity-0">
                        On-going
                    </label>

                    <label class="bg-lightGreen p-10 w-[32rem] font-semibold text-[24px] rounded-3xl text-center cursor-pointer focus-within:bg-normalGreen focus-within:text-white transition-all duration-100">
