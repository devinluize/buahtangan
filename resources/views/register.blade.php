    ...
    <div class="flex flex-row">
        ...
        <form  method="GET" class="w-[40rem] h-screen p-12 bg-white z-10 absolute right-0" action="{{ route('register.action') }}">
            ...
            <div class="flex flex-col font-poppins font-medium">
                ...
                <input type="text" name="username" class="bg-lightGreen shadow-md mb-6 h-[3rem] w-[32rem] rounded-md p-2 text-[18px]" required>

                <label class="text-[18px] text-blackGreen">Email</label>
                <input type="email" name="email" class="bg-lightGreen shadow-md mb-6 h-[3rem] w-[32rem] rounded-md p-2 text-[18px]" required>
            ...
            <button type="submit" class="bg-lightGreen p-3 font-bold text-2xl w-[32rem] mb-6 shadow-md rounded-md">REGISTER</button>
            <p class="text-[18px] font-semibold mt-6 text-center">Already have an account? <a class="underline cursor-pointer" href="/login">Sign In</a></p>
        </form>
    </div>
</body>
</html>
