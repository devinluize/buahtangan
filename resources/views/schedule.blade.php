    ...
    <div class="max-w-full mx-auto mt-8 pt-20 pl-20 bg-white">
            ...
            <div class="flex mb-4">
                ...
                <div class="flex-1 bg-green-600 bg-opacity-25 p-4 rounded-tr-lg rounded-br-lg">
                    <div class="flex justify-between mb-2">
                        <p class="text-2xl text-green-600 font-beVietnam font-bold">{{ $sch->sch_name }}</p>
                        <p class="text-green-600 font-beVietnam">
                            {{ \Carbon\Carbon::parse($sch->created_at)->format('j F Y') }}</p>
                    </div>
                    <p class="text-green-600 mb-2 font-beVietnam"> {{ $sch->sch_desc }}</p>
                    <div class="flex items-center pt-4">
                        <img src="{{ asset('images/clock.png') }}" alt="Clock" class="w-6 h-6 mr-2 clock-icon-green">
                        <p class="text-green-600 font-beVietnam">
                            {{ \Carbon\Carbon::parse($sch->start)->format('H:i:s') }}-{{ \Carbon\Carbon::parse($sch->end)->format('H:i:s') }}
        ...
        <div class="flex">
            ...
            <div class="flex-1 bg-[#B8922F] bg-opacity-25 p-4 rounded-tr-lg rounded-br-lg">
                ...
                <p class="text-[#B8922F] text-sm mb-2 font-beVietnam">Beansprout needs your care, fertilize the plant now.
                </p>
                <div class="flex items-center pt-4">
                    <img src="{{ asset('images/clock.png') }}" alt="Clock" class="w-6 h-6 mr-2 clock-icon-green">
