...
@section('content')
    ...
    <div class="flex ml-[5rem] mr-[5rem] mt-[6rem] flex-col">
        ...
        <div
            class="flex flex-row mx-auto font-beVietnam justify-between mt-16 border-lightGrey border-[0.3rem] p-[4rem] w-[84rem] shadow-md">
            ...
            <div class="border-lightBrown border-2 rounded-full p-8 bg-lightBrown w-[20rem] h-[20rem]">
                <img src="{{ asset('images/fertilizing.png') }}" alt="Fertilizing"
                    class="w-[9rem] h-[9rem] mx-auto mt-8 mb-8">
        ...
        <div class="flex justify-between">
            <a href={{ route('my-plants/plant-detail/view-album', ['id' => $id]) }}
                class="flex flex-row font-beVietnam justify-between mt-16 border-lightGrey border-[0.3rem] p-[4rem] w-[26rem] h-[22rem] cursor-pointer shadow-md">
                <div class="mx-auto">
            ...
            <div
                class="flex flex-col font-beVietnam justify-between mt-16 border-lightGrey border-[0.3rem] p-[4rem] w-[54rem] h-[22rem] cursor-pointer shadow-md">
