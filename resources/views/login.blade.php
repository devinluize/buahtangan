...
<body>
    <div class="flex flex-row">
        ...
        <form class="w-[40rem] h-screen p-12 bg-white z-10 absolute right-0">
            ...
            <button type="submit" class="bg-lightGreen p-3 font-bold text-2xl w-[32rem] mb-6 shadow-md rounded-md">LOGIN</button>
            <a class="text-right w-screen ml-[22rem] cursor-pointer text-gray-500  font-semibold text-[18px]">Forget password ?</a>
            <p class="text-[18px] font-semibold mt-24 text-center">Don't have an account yet? <a href="/register" class="underline cursor-pointer">Sign Up</a></p>
        </form>
    </div>
</body>
</html>